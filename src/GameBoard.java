...
public class GameBoard extends JPanel {
    ...
    private void updateStatus() {
        if (board.getTurn()) {
            status.setText("White's Turn");
            if (board.isCheck()) {
                status.setText("White's Turn, Under Check");
            ...
            if (board.isCheck()) {
                status.setText("Black's Turn, Under Check");
                if (board.getCheckMate()) {
    ...
    public void paintComponent(Graphics g) {
        ...
        HashMap<Integer, String> numbers2Piece = new HashMap<Integer, String>();
        numbers2Piece.put(0, "Pawn");
        numbers2Piece.put(1, "Queen");
        numbers2Piece.put(2, "Rook");
        numbers2Piece.put(3, "Knight");
        numbers2Piece.put(4, "Bishop");
        numbers2Piece.put(5, "King");
        ...
        for (int x = 0; x < numbers.length; x++) {
            ...
            for (int y = 0; y < numbers[x].length; y++) {
                ...
                String pieceType = numbers2Piece.get(y);
                if (number != 0) {
                    if (x == 0) {
        ...
        g.drawString("Click any of the pieces to see possible moves.", 1050, 100);
